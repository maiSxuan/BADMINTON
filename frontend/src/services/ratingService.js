...
/**
 * Service object chứa tất cả các phương thức gọi API liên quan đến đánh giá (rating).
 */
const ratingService = {
  /**
   ...
   * @example
   * const { reviews, totalCount } = await ratingService.getRatingsByProduct('60e...', 5); // Lấy 5 review mới nhất
   * console.log(`Sản phẩm này có tổng cộng ${totalCount} đánh giá.`);
   */
  getRatingsByProduct: async (productId, limit) => {
