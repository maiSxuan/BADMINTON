  ...
  const UserListPage = () => {
    ...
    if (!token || !user || user.user_type !== "ADMIN") {
      showPopup("Thông báo", "Bạn không có quyền truy cập trang này.", "Đóng", () => {
        navigate("/login");
      });
      return;
    }
    ...
    const getUserData = async () => {
      try {
        ...
        showPopup("Lỗi", "Không thể tải danh sách người dùng.", "Quay lại", () => {
          navigate("/");
        });
      }
    };
    ...
    showPopup(
      ...
      async () => {
        try {
          ...
          showPopup("Lỗi", "Lỗi khi cập nhật trạng thái: " + err.message, "Đóng");
        }
      }
    );
  };
